...
achievements:
  - date: "2026-05-01"
    ...
    kind: award
    url: https://aws.amazon.com/jp/blogs/psa/2026-japan-all-aws-certifications-engineers/
  - date: "2018-03-01"
    name: 双方向性と非線形性を考慮した上位語・下位語関係の推定（言語処理学会 第24回年次大会）
    kind: talk
    url: https://www.anlp.jp/proceedings/annual_meeting/2018/pdf_dir/D4-4.pdf
  - date: "2017-08-31"
    name: "特許出願: 話題推定学習装置及び話題推定学習方法（特開2017-151838）"
    kind: other
    url: https://patents.google.com/patent/JP2017151838A/ja
  - date: "2016-12-01"
  ...
  - date: "2016-03-01"
    name: 言語処理学会 若手奨励賞
    kind: award
    url: https://www.anlp.jp/award/nenji.html
  - date: "2016-03-01"
    name: 上位語・下位語の射影関係とそのクラスタの同時学習（言語処理学会 第22回年次大会）
    kind: talk
    url: https://www.anlp.jp/proceedings/annual_meeting/2016/pdf_dir/B3-4.pdf
```
