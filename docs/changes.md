...
| 10 | `followup-hardening` | #29 | — | 2026-09-22 | 写真入稿の冪等化と引数解析、OGP/Twitter カード、色コントラストの検算、暦の検査と日英パリティの強化、`base`/弱い assert の整理、e2e の拡充と CI（deploy.yml）の permissions を job 単位に、404/ヘッダーの細部修正 |
