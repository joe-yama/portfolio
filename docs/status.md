...
3. Change 7 が後続へ回した 14 件、Change 8 の 16 件、Change 9 の 8 件、Change 10 の 35 件超、Change 11 の 19 件（20 件のうち隔離実行の手順の件は 2026-09-23 に対応済み）、**`fix-misc` の 5 件（ブランチレビューの Minor 指摘）**（各 `openspec/changes/archive/*/tasks.md` の末尾）
