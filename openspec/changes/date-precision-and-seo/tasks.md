...
- [ ] 1.1 `src/content/schemas.ts` の資格・実績の `date` を `YYYY-MM` と `YYYY-MM-DD` の両方を受ける 1 本の正規表現（design D1）にし、`tests/unit/schemas.test.ts` に受理（`2025-10` / `2017-08-31`）と拒否（`2025` / `2025-10-1` / `2025-13` / `2025-10-32`）のテストを足して `pnpm test` が緑になることを確認する
